...
export default function Tier({ desc, tier, achievementDate }: IBestTier) {
  return (
    <li className="flex flex-col gap-[10px] relative w-full p-5 border border-white border-solid rounded-2xl transition-all hover:shadow-md hover:shadow-white md:w-[calc(50%-10px)]">
